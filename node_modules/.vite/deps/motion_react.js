import {
  require_jsx_runtime
} from "./chunk-7U4BQUI5.js";
import {
  __export,
  __require,
  __toESM,
  require_react
} from "./chunk-AOGOAKFD.js";
...
function arc(options = {}) {
  ...
  const path = {
    ...
    animateVisualElement(visualElement, target, transition, delay2, animations2) {
      ...
      const xRaw = target.x;
      const yRaw = target.y;
      const xFrom = (Array.isArray(xRaw) && xRaw[0] != null ? xRaw[0] : xValue == null ? void 0 : xValue.get()) ?? 0;
      const yFrom = (Array.isArray(yRaw) && yRaw[0] != null ? yRaw[0] : yValue == null ? void 0 : yValue.get()) ?? 0;
      ...
      progress2.start(animateMotionValue("", progress2, [0, 1e3], {
        ...
        onUpdate: (latest) => {
          ...
          xValue == null ? void 0 : xValue.set(point2.x);
          yValue == null ? void 0 : yValue.set(point2.y);
          if (pathRotationValue && point2.rotate !== void 0) {
            pathRotationValue.set(point2.rotate);
          }
        },
        onComplete: () => {
          xValue == null ? void 0 : xValue.set(xTo);
          yValue == null ? void 0 : yValue.set(yTo);
          pathRotationValue == null ? void 0 : pathRotationValue.set(0);
        },
        // Interrupt/cancel must clear our additive contribution
        // so it can't linger on top of the user's `rotate`.
        onStop: () => pathRotationValue == null ? void 0 : pathRotationValue.set(0),
        onCancel: () => pathRotationValue == null ? void 0 : pathRotationValue.set(0)
      }));
...
function tagClass(element, className, classed) {
  ...
  if (!className)
    return;
  (_a = element.style) == null ? void 0 : _a.setProperty("view-transition-class", className);
...
function applyGroup(element, name, group, grouped, clipChildren) {
  ...
  if (!group)
    return;
  (_a = element.style) == null ? void 0 : _a.setProperty("view-transition-group", group);
...
function assignViewTransitionNames(definition, registry, assigned, forcedNames, className, classed = [], group, grouped = [], clipChildren) {
  ...
  if (forcedNames) {
    return elements.map((element, i) => {
      ...
      (_a = element.style) == null ? void 0 : _a.setProperty("view-transition-name", name);
...
function releaseViewTransitionNames(assigned, classed = [], grouped = []) {
  ...
  for (const element of assigned) {
    (_a = element.style) == null ? void 0 : _a.removeProperty("view-transition-name");
  }
  for (const element of classed) {
    (_b = element.style) == null ? void 0 : _b.removeProperty("view-transition-class");
  }
  for (const element of grouped) {
    (_c = element.style) == null ? void 0 : _c.removeProperty("view-transition-group");
  }
}
...
function getViewAnimations() {
  return document.getAnimations().filter((animation) => {
    ...
    return !!effect && effect.target === document.documentElement && ((_a = effect.pseudoElement) == null ? void 0 : _a.startsWith("::view-transition"));
  });
}
...
function startViewAnimation(builder) {
      ...
      if (definition === "root" || !resolveDefs.has(definition)) {
        ...
        if (phase === "old") {
          ...
          for (const el of pairFrom.get(definition) ?? []) {
            (_a = el.style) == null ? void 0 : _a.removeProperty("view-transition-name");
  ...
  const staggerPosition = (name, type) => {
    const stagger2 = layerStagger.get(name);
    const position = type === "old" ? stagger2 == null ? void 0 : stagger2.old : type === "new" ? stagger2 == null ? void 0 : stagger2.new : (
      // group / group-children / image-pair persist across both.
      (stagger2 == null ? void 0 : stagger2.new) ?? (stagger2 == null ? void 0 : stagger2.old)
    );
    return position ?? [-1, 1];
  };
  ...
  const measureLayers = (phase) => nameRegistry.forEach((name, element) => {
    var _a;
    const el = element;
    const rect = (_a = el.getBoundingClientRect) == null ? void 0 : _a.call(el);
    if (rect && rect.height) {
  ...
  const aspectChanged = (name) => {
    ...
    if (!(box == null ? void 0 : box.old) || !(box == null ? void 0 : box.new) || !box.old.height || !box.new.height) {
      return false;
    }
  ...
  return new Promise((resolve, reject) => {
    transition.ready.then(() => {
      ...
      layerTargets.forEach((target, name) => {
        var _a, _b, _c, _d;
        const stagger2 = layerStagger.get(name);
        const enterApplies = !!(stagger2 == null ? void 0 : stagger2.new) && !(stagger2 == null ? void 0 : stagger2.old);
        const exitApplies = !!(stagger2 == null ? void 0 : stagger2.old) && !(stagger2 == null ? void 0 : stagger2.new);
        for (const key of definitionNames) {
          ...
          for (let [valueName, valueKeyframes] of Object.entries(keyframes2)) {
            ...
            if (key === "new" && enterApplies && ((_a = target.enter) == null ? void 0 : _a.keyframes[valueName]) != null) {
              continue;
            }
            if (key === "old" && exitApplies && ((_b = target.exit) == null ? void 0 : _b.keyframes[valueName]) != null) {
              continue;
            }
            ...
            if (!Array.isArray(valueKeyframes)) {
              const exitValue = key === "enter" ? (_c = target.exit) == null ? void 0 : _c.keyframes[valueName] : void 0;
              const allowDefault = valueName === "opacity" || (type === "new" ? enterApplies : exitApplies);
              const from = exitValue != null ? Array.isArray(exitValue) ? exitValue[exitValue.length - 1] : exitValue : allowDefault ? (_d = ORIGIN_DEFAULTS[type]) == null ? void 0 : _d[valueName] : void 0;
              if (from !== void 0) {
      ...
      for (const animation of generatedViewAnimations) {
        ...
        const isMorphCrossfade = (name.type === "old" || name.type === "new") && !!(stagger2 == null ? void 0 : stagger2.old) && !!(stagger2 == null ? void 0 : stagger2.new);
        let timing;
      ...
      cropMeasurements.forEach((entry, name) => {
        ...
        for (const corner of cornerRadiusProps) {
          const from = ((_a = entry.old) == null ? void 0 : _a.radii[corner]) || ((_b = entry.new) == null ? void 0 : _b.radii[corner]) || "0px";
          const to = ((_c = entry.new) == null ? void 0 : _c.radii[corner]) || ((_d = entry.old) == null ? void 0 : _d.radii[corner]) || "0px";
...
function layerOptions(target, type) {
  ...
  for (const bucket of typeBuckets[type] ?? []) {
    const options = (_a = target == null ? void 0 : target[bucket]) == null ? void 0 : _a.options;
    if (options)
      return options;
  }
}
...
function dropNode(element, node) {
  ...
  if (!stack || node.isLead())
    (_a = node.currentAnimation) == null ? void 0 : _a.stop();
  node.unmount();
  ...
  reconcileRemovals(newMemberIds) {
    this.tracked.forEach((node, element) => {
      ...
      const hasSurvivor = stack && stack.members.some((member) => {
        var _a;
        return member !== node && ((_a = member.instance) == null ? void 0 : _a.isConnected);
      });
